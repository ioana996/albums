...
var useReferenceArrayFieldController = function(props) {
  ...
  var _f = useGetManyAggregate(reference, { ids, meta }, __assign28({ onError: function(error2) {
...
var useReferenceManyFieldController = function(props) {
  ...
  var hideFilter = (0, import_react91.useCallback)(function(filterName) {
    setDisplayedFilters(function(previousState) {
      var _a2 = previousState, _b2 = filterName, _ = _a2[_b2], newState = __rest19(_a2, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return newState;
    });
    setFilterValues(function(previousState) {
      var _a2 = previousState, _b2 = filterName, _ = _a2[_b2], newState = __rest19(_a2, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
...
function useForm(props = {}) {
  ...
  import_react92.default.useEffect(() => control._disableForm(props.disabled), [control, props.disabled]);
  import_react92.default.useEffect(() => {
...
var useReference = function(_a) {
  ...
  var meta = options.meta, otherQueryOptions = __rest22(options, ["meta"]);
...
var usePrevNextController = function(props) {
  ...
  var meta = queryOptions.meta, otherQueryOptions = __rest27(queryOptions, ["meta"]);
...
var useCreate = function(resource, params, options) {
  ...
  var create = function(callTimeResource, callTimeParams, createOptions) {
    ...
    var _a = createOptions.returnPromise, returnPromise = _a === void 0 ? options.returnPromise : _a, reactCreateOptions = __rest28(createOptions, ["returnPromise"]);
    if (returnPromise) {
...
var useDeleteMany = function(resource, params, options) {
  ...
  var queryClient = useQueryClient();
  var ids = params.ids;
  var _a = options.mutationMode, mutationMode = _a === void 0 ? "pessimistic" : _a, reactMutationOptions = __rest32(options, ["mutationMode"]);
...
var useInfiniteGetList = function(resource, params, options) {
  ...
  return result.data ? __assign41(__assign41({}, result), { data: result.data, total: (_c = (_b = (_a = result.data) === null || _a === void 0 ? void 0 : _a.pages[0]) === null || _b === void 0 ? void 0 : _b.total) !== null && _c !== void 0 ? _c : void 0 }) : result;
};
...
var ResourceDefinitionContextProvider = function(_a) {
  ...
  var unregister = (0, import_react105.useCallback)(function(config) {
    setState(function(prev) {
      var _a2 = prev, _b2 = config.name, _ = _a2[_b2], rest = __rest33(_a2, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return rest;
    });
  }, []);
...
var I18nContextProvider = function(_a) {
  ...
  return isInitialized ? React49.createElement(I18nContext.Provider, { value, key }, children) : null;
};
...
inflection/lib/inflection.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CP5XNZ4H.js.map
