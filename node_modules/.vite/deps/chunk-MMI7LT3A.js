...
var RecordRepresentation = function(props) {
  ...
  var resource = useResourceContext(props);
  var getRecordRepresentation = useGetRecordRepresentation(resource);
  return React26.createElement(React26.Fragment, null, getRecordRepresentation(record));
};
...
var EditBase = function(_a) {
  ...
  var body = React28.createElement(EditContextProvider, { value: controllerProps }, children);
  return props.resource ? (
    // support resource override via props
    React28.createElement(ResourceContextProvider, { value: props.resource }, body)
  ) : body;
};
  ...
  return React29.createElement(
    ...
    React29.createElement(
      ...
      React29.createElement(
        ...
        React29.createElement(ListPaginationContext.Provider, { value: usePickPaginationContext(value) }, children)
      )
    )
  );
};
...
var InfiniteListBase = function(_a) {
  ...
  return React30.createElement(
    ...
    React30.createElement(
      ...
      React30.createElement(InfinitePaginationContext.Provider, { value: {
...
var ListBase = function(_a) {
  ...
  return React31.createElement(
    ResourceContextProvider,
    { value: props.resource },
    React31.createElement(ListContextProvider, { value: useListController(props) }, children)
  );
};
...
var useReferenceArrayFieldController = function(props) {
  var _a = props.filter, filter = _a === void 0 ? defaultFilter2 : _a, _b = props.page, page = _b === void 0 ? 1 : _b, _c = props.perPage, perPage = _c === void 0 ? 1e3 : _c, record = props.record, reference = props.reference, _d = props.sort, sort = _d === void 0 ? defaultSort4 : _d, source = props.source, _e = props.queryOptions, queryOptions = _e === void 0 ? {} : _e;
  var notify = useNotify();
  var value = (0, import_get4.default)(record, source);
  var meta = queryOptions.meta, otherQueryOptions = __rest16(queryOptions, ["meta"]);
  ...
  var _f = useGetManyAggregate(reference, { ids, meta }, __assign23({ onError: function(error2) {
  ...
  } }, otherQueryOptions)), data = _f.data, error = _f.error, isLoading = _f.isLoading, isFetching = _f.isFetching, refetch2 = _f.refetch;
...
function useController(props) {
  ...
  import_react83.default.useEffect(() => {
    if (get6(control._fields, name)) {
      control._updateDisabledField({
        disabled,
        fields: control._fields,
        name,
        value: get6(control._fields, name)._f.value
      });
    }
...
function createFormControl(props = {}, flushRootRender) {
  ...
  const onChange = async (event) => {
    ...
    const _updateIsFieldValueUpdated = (fieldValue) => {
      isFieldValueUpdated = Number.isNaN(fieldValue) || fieldValue === get6(_formValues, name, fieldValue);
    };
    if (field) {
      let error;
      let isValid2;
  ...
  const _focusInput = (ref, key) => {
    if (get6(_formState.errors, key) && ref.focus) {
      ref.focus();
      return 1;
    }
    return;
  ...
  const _updateDisabledField = ({ disabled, name, field, fields, value }) => {
    if (isBoolean(disabled)) {
      const inputValue = disabled ? void 0 : isUndefined(value) ? getFieldValue(field ? field._f : get6(fields, name)._f) : value;
      set3(_formValues, name, inputValue);
...
function useForm(props = {}) {
  ...
  import_react83.default.useEffect(() => control._disableForm(props.disabled), [control, props.disabled]);
  import_react83.default.useEffect(() => {
...
var useReference = function(_a) {
  ...
  var meta = options.meta, otherQueryOptions = __rest20(options, ["meta"]);
...
var useReferenceInputController = function(props) {
  ...
  var _g = useReference({
    ...
    options: __assign28({ enabled: currentValue != null && currentValue !== "", meta }, otherQueryOptions)
...
var ShowContextProvider = function(_a) {
  ...
  return React33.createElement(
    ...
    { value },
    React33.createElement(RecordContextProvider, { value: value && value.record }, children)
  );
};
...
var ShowBase = function(_a) {
  ...
  var body = React34.createElement(ShowContextProvider, { value: controllerProps }, children);
  return props.resource ? (
    // support resource override via props
    React34.createElement(ResourceContextProvider, { value: props.resource }, body)
  ) : body;
};
...
var usePrevNextController = function(props) {
  ...
  var filter = __assign30(__assign30({}, storedParams.filter), permanentFilter);
  var meta = queryOptions.meta, otherQueryOptions = __rest25(queryOptions, ["meta"]);
  var params = { pagination, sort, filter, meta };
  var queryData = queryClient.getQueryData([
    resource,
    "getList",
    __assign30(__assign30({}, params), { pagination: {
  ...
  }, __assign30({ enabled: !canUseCacheData }, otherQueryOptions)), data = _j.data, error = _j.error, isLoading = _j.isLoading;
  ...
  return {
    ...
    hasNext: nextId !== null,
    prevPath: previousId !== null ? createPath2({
      type: linkType,
      resource,
      id: previousId
    }) : void 0,
    nextPath: nextId !== null ? createPath2({
      type: linkType,
      resource,
      id: nextId
    }) : void 0,
...
var useCreate = function(resource, params, options) {
  ...
  }, __assign31(__assign31({}, options), { onSuccess: function(data, variables, context) {
    if (variables === void 0) {
      variables = {};
    }
  ...
  var create = function(callTimeResource, callTimeParams, createOptions) {
    ...
    if (returnPromise) {
      return mutation.mutateAsync(__assign31({ resource: callTimeResource }, callTimeParams), createOptions);
    }
    mutation.mutate(__assign31({ resource: callTimeResource }, callTimeParams), reactCreateOptions);
  };
  ...
  var updateCache = function(_a2) {
    ...
    var updateColl = function(old) {
      ...
      return __spreadArray13(__spreadArray13(__spreadArray13([], old.slice(0, index), true), [
        __assign32(__assign32({}, old[index]), data2)
      ...
      return __generator5(this, function(_e) {
        switch (_e.label) {
          ...
          case 1:
            ...
            if (onSuccess) {
              setTimeout(function() {
                return onSuccess(__assign32(__assign32({}, previousRecord), callTimeData), __assign32({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (reactMutationOptions.onSuccess) {
              setTimeout(function() {
                return reactMutationOptions.onSuccess(__assign32(__assign32({}, previousRecord), callTimeData), __assign32({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
      ...
      return __generator6(this, function(_b) {
        ...
        updateColl = function(old) {
          ...
          ids2.forEach(function(id) {
            ...
            newCollection = __spreadArray14(__spreadArray14(__spreadArray14([], newCollection.slice(0, index), true), [
              __assign33(__assign33({}, newCollection[index]), data2)
        ...
        ids2.forEach(function(id) {
          return queryClient.setQueryData([resource2, "getOne", { id: String(id), meta: meta2 }], function(record) {
            return __assign33(__assign33({}, record), data2);
          }, { updatedAt });
        });
        queryClient.setQueriesData([resource2, "getList"], function(res) {
          return res && res.data ? __assign33(__assign33({}, res), { data: updateColl(res.data) }) : res;
        }, { updatedAt });
        queryClient.setQueriesData([resource2, "getInfiniteList"], function(res) {
          return res && res.pages ? __assign33(__assign33({}, res), { pages: res.pages.map(function(page) {
            return __assign33(__assign33({}, page), { data: updateColl(page.data) });
          }) }) : res;
        }, { updatedAt });
        queryClient.setQueriesData([resource2, "getMany"], function(coll) {
          return coll && coll.length > 0 ? updateColl(coll) : coll;
      ...
      return __generator6(this, function(_d) {
        switch (_d.label) {
          case 0:
            ...
            if (mode.current === "pessimistic") {
              if (returnPromise) {
                return [2, mutation.mutateAsync(__assign33({ resource: callTimeResource }, callTimeParams), { onSuccess, onSettled, onError })];
              }
          ...
          case 2:
            ...
            if (onSuccess) {
              setTimeout(function() {
                return onSuccess(callTimeIds, __assign33({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (reactMutationOptions.onSuccess) {
              setTimeout(function() {
                return reactMutationOptions.onSuccess(callTimeIds, __assign33({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (mode.current === "optimistic") {
  ...
  var updateCache = function(_a2) {
    ...
    queryClient.setQueriesData([resource2, "getInfiniteList"], function(res) {
      ...
      return __assign34(__assign34({}, res), { pages: res.pages.map(function(page) {
        ...
        return recordWasFound ? __assign34(__assign34({}, page), { data: newCollection, total: page.total ? page.total - 1 : void 0, pageInfo: page.pageInfo }) : page;
      }) });
    }, { updatedAt });
    queryClient.setQueriesData([resource2, "getMany"], function(coll) {
      return coll && coll.length > 0 ? updateColl(coll) : coll;
      ...
      return __generator7(this, function(_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            if (onSuccess) {
              setTimeout(function() {
                return onSuccess(callTimePreviousData, __assign34({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (reactMutationOptions.onSuccess) {
              setTimeout(function() {
                return reactMutationOptions.onSuccess(callTimePreviousData, __assign34({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (mode.current === "optimistic") {
...
var useDeleteMany = function(resource, params, options) {
  ...
  var updateCache = function(_a2) {
    ...
    queryClient.setQueriesData([resource2, "getInfiniteList"], function(res) {
      if (!res || !res.pages)
        return res;
      return __assign35(__assign35({}, res), { pages: res.pages.map(function(page) {
        var newCollection = updateColl(page.data);
        var recordWasFound = newCollection.length < page.data.length;
        return recordWasFound ? __assign35(__assign35({}, page), { data: newCollection, total: page.total ? page.total - (page.data.length - newCollection.length) : void 0, pageInfo: page.pageInfo }) : page;
      }) });
    }, { updatedAt });
    queryClient.setQueriesData([resource2, "getMany"], function(coll) {
      return coll && coll.length > 0 ? updateColl(coll) : coll;
      ...
      return __generator8(this, function(_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (onSuccess) {
              setTimeout(function() {
                return onSuccess(callTimeIds, __assign35({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (reactMutationOptions.onSuccess) {
              setTimeout(function() {
                return reactMutationOptions.onSuccess(callTimeIds, __assign35({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (mode.current === "optimistic") {
...
var useInfiniteGetList = function(resource, params, options) {
  ...
  }, __assign36(__assign36({ onSuccess: function(data) {
  ...
  return result.data ? __assign36(__assign36({}, result), { data: result.data, total: (_c = (_b = (_a = result.data) === null || _a === void 0 ? void 0 : _a.pages[0]) === null || _b === void 0 ? void 0 : _b.total) !== null && _c !== void 0 ? _c : void 0 }) : result;
};
...
var ResourceDefinitionContextProvider = function(_a) {
  ...
  var register = (0, import_react96.useCallback)(function(config) {
    setState(function(prev) {
      var _a2;
      return (0, import_isEqual5.default)(prev[config.name], config) ? prev : __assign37(__assign37({}, prev), (_a2 = {}, _a2[config.name] = config, _a2));
    });
  }, []);
...
var useRoutesAndResourcesFromChildren = function(children, permissions, isLoading) {
  ...
  var _b = useSafeSetState(function() {
    return getStatus(__assign38({ children }, routesAndResources));
    ...
    React39.createElement(Route, { path: "/*", element: React39.createElement(
      ...
      React39.createElement(
        ...
        React39.createElement(
          ...
          React39.createElement(Route, { path: "/", element: dashboard ? React39.createElement(WithPermissions_default, { authParams: defaultAuthParams2, component: dashboard }) : resources.length > 0 ? React39.createElement(Navigate, { to: createPath2({
            resource: resources[0].props.name,
            type: "list"
          }) }) : null }),
          React39.createElement(Route, { path: "*", element: React39.createElement(CatchAll, { title }) })
        )
      )
    ) })
  );
...
var CoreAdminUI = function(props) {
  ...
  return React40.createElement(
    ...
    React40.createElement(Route, { path: "/*", element: React40.createElement(CoreAdminRoutes, { catchAll, dashboard, layout, loading, menu, requireAuth, ready, title }, children) })
  );
};
...
var CoreAdmin = function(props) {
  ...
  return React41.createElement(
    ...
    React41.createElement(CoreAdminUI, { layout, dashboard, disableTelemetry, menu, catchAll, title, loading, loginPage, requireAuth, ready }, children)
  );
};
...
var Resource = function(props) {
  ...
  return React43.createElement(
    ...
    React43.createElement(
      Routes,
      null,
      create && React43.createElement(Route, { path: "create/*", element: getElement(create) }),
      show && React43.createElement(Route, { path: ":id/show/*", element: getElement(show) }),
      edit && React43.createElement(Route, { path: ":id/*", element: getElement(edit) }),
      list && React43.createElement(Route, { path: "/*", element: getElement(list) }),
      props.children
    )
  );
};
var getElement = function(ElementOrComponent) {
  ...
  if ((0, import_react_is.isValidElementType)(ElementOrComponent)) {
    return React43.createElement(ElementOrComponent, null);
  }
  return null;
};
...
var useGetRecordRepresentation = function(resource) {
  ...
  return (0, import_react106.useCallback)(function(record) {
    ...
    if (React44.isValidElement(recordRepresentation)) {
...
var FieldTitle = function(props) {
  ...
  return React45.createElement(
    ...
    isRequired3 && React45.createElement("span", { "aria-hidden": "true" }, " *")
  );
};
...
function useWhyDidYouUpdate(name, props) {
  ...
  (0, import_react113.useEffect)(function() {
    if (previousProps.current) {
      var allKeys = Object.keys(__assign40(__assign40({}, previousProps.current), props));
      var changesObj_1 = {};
...
var useLayoutEffect3 = typeof window !== "undefined" ? React47.useLayoutEffect : React47.useEffect;
var useEvent = function(fn) {
  var ref = React47.useRef(function() {
...
var LabelPrefixContextProvider = function(_a) {
  ...
  return React48.createElement(LabelPrefixContext.Provider, { value: newPrefix }, children);
};
...
var useCheckForApplicationUpdate = function(options) {
  ...
  var currentHash = (0, import_react117.useRef)();
...
var useStore = function(key, defaultValue) {
  ...
  var _b = (0, import_react118.useState)(function() {
...
var useRemoveFromStore = function(hookTimeKey) {
  ...
  return (0, import_react119.useCallback)(function(key) {
...
var useRemoveItemsFromStore = function(hookTimeKeyPrefix) {
  ...
  return (0, import_react120.useCallback)(function(keyPrefix) {
...
var useLogout = function() {
  ...
  var navigate = useNavigate();
  var navigateRef = (0, import_react121.useRef)(navigate);
  var location = useLocation();
  var locationRef = (0, import_react121.useRef)(location);
  var basename = useBasename();
  ...
  var logout = (0, import_react121.useCallback)(function(params, redirectTo, redirectToCurrentLocationAfterLogin) {
    if (params === void 0) {
      params = {};
    }
  ...
  var logoutWithoutProvider = (0, import_react121.useCallback)(function(_) {
    navigate({
      pathname: loginUrl
    }, {
      state: {
...
var usePermissions = function(params, queryParams) {
  ...
  }, __assign42({ onError: function(error) {
    if (true) {
      console.error(error);
    }
...
var useAuthenticated = function(_a) {
  ...
  var params = _a.params, options = __rest32(_a, ["params"]);
...
var isEmptyChildren = function(children) {
  return import_react124.Children.count(children) === 0;
};
var WithPermissions = function(props) {
  var authParams = props.authParams, children = props.children, render = props.render, component = props.component, staticContext = props.staticContext, rest = __rest33(props, ["authParams", "children", "render", "component", "staticContext"]);
  ...
  if (component) {
    return (0, import_react124.createElement)(component, __assign43({ permissions }, rest));
  }
  if (render) {
    return render(__assign43({ permissions }, rest));
  }
  if (children) {
    return children(__assign43({ permissions }, rest));
  }
};
...
var useLogin = function() {
  ...
  var login = (0, import_react125.useCallback)(function(params, pathName) {
    if (params === void 0) {
      params = {};
    }
  ...
  var loginWithoutProvider = (0, import_react125.useCallback)(function(_, __) {
    resetNotifications();
...
var useGetPermissions = function() {
  var authProvider = useAuthProvider_default();
  var getPermissions = (0, import_react126.useCallback)(function(params) {
    if (params === void 0) {
      params = {};
    }
    return authProvider.getPermissions(params);
...
var useCheckAuth = function() {
  ...
  var basename = useBasename();
  var loginUrl = removeDoubleSlashes2("".concat(basename, "/").concat(defaultAuthParams.loginUrl));
  var checkAuth = (0, import_react127.useCallback)(function(params, logoutOnFailure, redirectTo, disableNotification) {
    if (params === void 0) {
      params = {};
    }
    if (logoutOnFailure === void 0) {
...
var useGetIdentity = function(queryParams) {
  ...
  }, __assign44({ enabled: typeof (authProvider === null || authProvider === void 0 ? void 0 : authProvider.getIdentity) === "function" }, queryParams));
  return (0, import_react128.useMemo)(function() {
...
var useHandleAuthCallback = function(options) {
  ...
  }, __assign45({ retry: false, onSuccess: function(data) {
    var _a;
...
var FormDataConsumer = function(props) {
  ...
  return React51.createElement(FormDataConsumerView, __assign47({ formData }, props));
};
var FormDataConsumerView = function(props) {
  var children = props.children, form = props.form, formData = props.formData, source = props.source, index = props.index, rest = __rest34(props, ["children", "form", "formData", "source", "index"]);
  var ret;
...
var ValidationError = function(props) {
  ...
  if (errorMessage.message) {
    ...
    return React52.createElement(React52.Fragment, null, translate(message, __assign48({ _: message }, args)));
  }
  return React52.createElement(React52.Fragment, null, translate(errorMessage, { _: errorMessage }));
};
...
var ChoicesContextProvider = function(_a) {
  var children = _a.children, value = _a.value;
  return React53.createElement(ChoicesContext.Provider, { value }, children);
};
...
var useChoicesContext = function(options) {
  ...
  var _a = useList({
    ...
    perPage: Infinity
  }), data = _a.data, list = __rest35(_a, ["data"]);
...
var FormGroupsProvider = function(_a) {
  ...
  return React54.createElement(FormGroupsContext.Provider, { value: formContextValue }, children);
};
    ...
    React55.createElement(
      ...
      React55.createElement(
        ...
        React55.createElement(
          FormGroupsProvider,
          null,
          React55.createElement("form", { onSubmit: formHandleSubmit, noValidate, id, className }, children)
        )
      )
    )
  );
...
var FormGroupContextProvider = function(_a) {
  ...
  return React56.createElement(FormGroupContext.Provider, { value: name }, children);
};
...
var useChoices = function(_a) {
  ...
  var getChoiceText = (0, import_react144.useCallback)(function(choice) {
    if ((0, import_react144.isValidElement)(optionText)) {
      return React57.createElement(RecordContextProvider, { value: choice }, optionText);
    }
...
var useInput = function(props) {
  var defaultValue = props.defaultValue, _a = props.format, format2 = _a === void 0 ? defaultFormat : _a, id = props.id, isRequiredOption = props.isRequired, name = props.name, initialOnBlur = props.onBlur, initialOnChange = props.onChange, _b = props.parse, parse4 = _b === void 0 ? defaultParse : _b, source = props.source, validate = props.validate, options = __rest37(props, ["defaultValue", "format", "id", "isRequired", "name", "onBlur", "onChange", "parse", "source", "validate"]);
  ...
  var _c = useController(__assign53(__assign53({ name: finalName, defaultValue: (0, import_get12.default)(record, source, defaultValue), rules: {
...
var DefaultComponent = function() {
  return React58.createElement("span", null, ";");
};
var defaultType = {
...
inflection/lib/inflection.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MMI7LT3A.js.map
